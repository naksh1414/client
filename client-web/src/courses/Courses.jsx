...
// import img from "../assets/home/240_F_365794259_Den5m4gcq1CKclZbqccNWgTe47QElx9p.jpg"
const { Meta } = Card;
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center">
        {/* <img className="absolute h-full w-full bg-no-repeat bg-cover bg-fixed bg-center " src={img} alt="bgimg" /> */}
